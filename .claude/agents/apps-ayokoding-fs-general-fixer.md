---
name: apps-ayokoding-fs-general-fixer
...
# General Content Fixer for ayokoding-fs
...
- Understanding of ayokoding-fs content standards
...
Skills: `apps-ayokoding-fs-developing-content`, `repo-assessing-criticality-confidence`, `repo-applying-maker-checker-fixer`, `repo-generating-validation-reports`
...
- `apps-ayokoding-fs-general-checker` - Generates audit reports this fixer processes
- `apps-ayokoding-fs-general-maker` - Creates content
