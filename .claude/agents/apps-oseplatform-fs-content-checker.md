---
name: apps-oseplatform-fs-content-checker
description: Validates oseplatform-fs content quality including Next.js content layer compliance and landing page standards.
...
# Content Checker for oseplatform-fs
...
- Advanced reasoning to validate oseplatform-fs content quality
...
Validate oseplatform-fs content quality.

## Temporary Reports

Pattern: `oseplatform-fs-content__{uuid-chain}__{YYYY-MM-DD--HH-MM}__audit.md`
...
- Skills: `apps-oseplatform-fs-developing-content`, `repo-assessing-criticality-confidence`, `repo-generating-validation-reports`
...
- `apps-oseplatform-fs-content-maker` - Creates content this checker validates
- `apps-oseplatform-fs-content-fixer` - Fixes issues found by this checker
