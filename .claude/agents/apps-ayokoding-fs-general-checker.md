---
name: apps-ayokoding-fs-general-checker
description: Validates general ayokoding-fs content quality including bilingual completeness and content quality.
...
# General Content Checker for ayokoding-fs
...
Validate general ayokoding-fs content quality.

## Temporary Reports

Pattern: `ayokoding-fs-general__{uuid-chain}__{YYYY-MM-DD--HH-MM}__audit.md`
Skill: `repo-generating-validation-reports`

## Validation Scope

`apps-ayokoding-fs-developing-content` Skill provides complete standards:
...
- Skills: `apps-ayokoding-fs-developing-content`, `repo-assessing-criticality-confidence`, `repo-generating-validation-reports`
...
- `apps-ayokoding-fs-general-maker` - Creates content this checker validates
- `apps-ayokoding-fs-general-fixer` - Fixes issues found by this checker
