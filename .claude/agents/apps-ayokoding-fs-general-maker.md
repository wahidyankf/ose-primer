...
description: Creates general ayokoding-fs content (by-concept tutorials, guides, references). Ensures bilingual completeness and content quality compliance.
...
# General Content Maker for ayokoding-fs
...
Create by-concept tutorials and general content for ayokoding-fs.

## Reference

- Skills: `apps-ayokoding-fs-developing-content` (bilingual, content workflow), `docs-creating-accessible-diagrams`, `docs-applying-content-quality`

## Workflow

1. Determine content path and category
2. Create frontmatter (title, metadata)
3. Write content following ayokoding-fs standards
...
- `apps-ayokoding-fs-general-checker` - Validates content created by this maker
- `apps-ayokoding-fs-general-fixer` - Fixes validation issues
