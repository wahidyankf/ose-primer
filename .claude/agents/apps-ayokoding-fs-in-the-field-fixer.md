---
name: apps-ayokoding-fs-in-the-field-fixer
description: Applies validated fixes from apps-ayokoding-fs-in-the-field-checker audit reports. Re-validates in-the-field findings before applying changes. Use after reviewing checker output.
...
# In-the-Field Tutorial Fixer for ayokoding-fs
...
- `apps-ayokoding-fs-in-the-field-maker` - Creates content
- `apps-ayokoding-fs-in-the-field-checker` - Validates content (generates audits)
