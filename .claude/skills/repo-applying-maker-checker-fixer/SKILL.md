...
```markdown
User: "Apply fixes from latest ayokoding-fs audit"
...
2. **apps-ayokoding-fs-\*** - Content (ayokoding-fs, Next.js)
3. **docs-tutorial-\*** - Tutorial quality
4. **apps-oseplatform-fs-content-\*** - Hugo content (oseplatform-fs)
