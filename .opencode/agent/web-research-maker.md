...
- `docs-checker`, `apps-a-demo-fs-ts-nextjs-facts-checker` — validate existing repo content against facts; may invoke `web-research-maker` when they need current data before producing findings
