...
(`specs/apps/crud/behavior/crud-be/gherkin/`) drive all three levels. Only the step implementations differ.
...
`../../specs` at `/specs` so the Godog path `/specs/apps/crud/behavior/crud-be/gherkin` resolves correctly.
