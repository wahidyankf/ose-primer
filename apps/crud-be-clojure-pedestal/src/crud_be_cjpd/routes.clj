(ns crud-be-cjpd.routes
  "Pedestal route table definition."
  (:require [io.pedestal.http.route.definition.table :as table]
            [crud-be-cjpd.interceptors.json :as json-int]
            [crud-be-cjpd.interceptors.auth :as auth-int]
            [crud-be-cjpd.interceptors.admin :as admin-int]
            [crud-be-cjpd.interceptors.error :as error-int]
            [crud-be-cjpd.interceptors.multipart :as multipart-int]
            [crud-be-cjpd.handlers.health :as health]
            [crud-be-cjpd.handlers.auth :as auth-h]
            [crud-be-cjpd.handlers.user :as user-h]
            [crud-be-cjpd.handlers.admin :as admin-h]
            [crud-be-cjpd.handlers.expense :as expense-h]
            [crud-be-cjpd.handlers.attachment :as attachment-h]
            [crud-be-cjpd.handlers.report :as report-h]
            [crud-be-cjpd.handlers.token :as token-h]
            [crud-be-cjpd.handlers.jwks :as jwks-h]
            [crud-be-cjpd.handlers.test-api :as test-api-h]))
