...
```bash
export DATABASE_URL="jdbc:postgresql://localhost:5432/crud_be_cjpd"
export DB_USER="crud_be_cjpd"
export DB_PASSWORD="crud_be_cjpd"
```
...
- `test/crud_be_cjpd/**/*_test.clj` — clojure.test namespaces
...
The `crud-be-cjpd.main` namespace is excluded from coverage (entry point only).
