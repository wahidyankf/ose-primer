...
export const logger = {
  ...
  info: (message: string, context?: Record<string, unknown>) => logger._log("info", message, context),
  // => info: routine operational events
  warn: (message: string, context?: Record<string, unknown>) => logger._log("warn", message, context),
  // => warn: unexpected conditions that don't prevent operation
  error: (message: string, context?: Record<string, unknown>) => logger._log("error", message, context),
