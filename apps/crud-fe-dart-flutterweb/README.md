# crud-fe-dart-flutterweb

Flutter Web frontend for demo expense tracking — an alternative implementation
to `crud-fe-ts-nextjs` (Next.js).
...
- **E2E Tests**: Shared [`crud-fe-e2e`](../crud-fe-e2e/README.md) Playwright tests
...
docker compose -f infra/dev/crud-fe-dart-flutterweb/docker-compose.yml up --build
