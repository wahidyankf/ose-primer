...
void main() {
  ...
  describeFeature(
    '../../specs/apps/crud/fe/gherkin/authentication/session.feature',
    (feature) {
      // -----------------------------------------------------------------------
      ...
      // -----------------------------------------------------------------------
      feature.scenario('Original refresh token is rejected after rotation', (
        s,
      ) {
        late String originalRefreshToken;
        ServiceError? caughtError;
      ...
      // -----------------------------------------------------------------------
      feature.scenario('Clicking "Log out all devices" ends all sessions', (s) {
        s.given('the app is running', () async {});
