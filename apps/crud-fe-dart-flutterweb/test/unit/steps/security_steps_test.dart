...
void main() {
  ...
  describeFeature(
    '../../specs/apps/crud/behavior/crud-web/gherkin/security/security.feature',
    (feature) {
      // -----------------------------------------------------------------------
      ...
      feature.scenario(
        ...
        (s) {
          ...
          s.and(
            'the error should mention minimum length requirements',
            () async {
              expect(
      ...
      // -----------------------------------------------------------------------
      feature.scenario('Admin unlocks a locked account via the admin panel', (
        s,
      ) {
        late String aliceId;
      ...
      // -----------------------------------------------------------------------
      feature.scenario('Unlocked account can log in with correct password', (
        s,
      ) {
        s.given('the app is running', () async {});
