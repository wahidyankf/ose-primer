...
void main() {
  ...
  describeFeature('../../specs/apps/crud/fe/gherkin/admin/admin-panel.feature', (
    feature,
  ) {
    // ---------------------------------------------------------------------------
    ...
    feature.scenario('Searching users by email filters the list', (s) {
      ...
      s.and(
        ...
        () async {
          userListResponse = await svc.listUsers(search: 'alice@example.com');
        },
      );
    ...
    // ---------------------------------------------------------------------------
    feature.scenario('Admin disables a user account from the user detail page', (
      s,
    ) {
      s.given('the app is running', () async {});
    ...
    // ---------------------------------------------------------------------------
    feature.scenario('Admin generates a password-reset token for a user', (s) {
      s.given('the app is running', () async {});
