...
void main() {
  ...
  describeFeature('../../specs/apps/crud/fe/gherkin/expenses/currency-handling.feature', (
    feature,
  ) {
    ...
    feature.scenario('Unsupported currency code shows a validation error', (s) {
    ...
    feature.scenario('Malformed currency code shows a validation error', (s) {
      ServiceError? caught;
    ...
    feature.scenario('Expense summary groups totals by currency', (s) {
      ...
      s.then('the summary should display a separate total for "USD"', () async {
      ...
      s.and('the summary should display a separate total for "IDR"', () async {
