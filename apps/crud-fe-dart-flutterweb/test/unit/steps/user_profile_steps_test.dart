...
void main() {
  ...
  describeFeature('../../specs/apps/crud/fe/gherkin/user-lifecycle/user-profile.feature', (
    feature,
  ) {
    // ---------------------------------------------------------------------------
    ...
    feature.scenario('Updating display name shows the new value', (s) {
      ...
      s.then('the profile should display display name "Alice Smith"', () async {
    ...
    // ---------------------------------------------------------------------------
    feature.scenario('Changing password with correct old password succeeds', (
      s,
    ) {
      s.given('the app is running', () async {});
    ...
    feature.scenario('Self-deactivating account redirects to login', (s) {
      ...
      s.then('alice should be redirected to the login page', () async {
        ...
        expect(
          svc.isAuthenticated,
          isFalse,
          reason: 'Session must be cleared after self-deactivation',
        );
      });
    });
