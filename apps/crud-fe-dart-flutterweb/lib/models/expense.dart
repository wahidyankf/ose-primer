import 'package:crud_contracts/crud_contracts.dart' as gen;
...
class Expense {
  ...
  factory Expense.fromJson(Map<String, dynamic> json) {
    ...
    assert(
      gen.Expense.requiredKeys.containsAll(const {
        'id',
        'amount',
        'currency',
        'category',
...
class UpdateExpenseRequest {
  ...
  Map<String, dynamic> toJson() {
    final typeEnum = type != null
        ? gen.UpdateExpenseRequestTypeEnum.fromJson(type)
        : null;
