defmodule CrudBeExphWeb.Router do
  use CrudBeExphWeb, :router

  pipeline :api do
    plug :accepts, ["json"]
    plug CrudBeExphWeb.CorsPlug
  end

  pipeline :auth do
    plug Guardian.Plug.Pipeline,
      module: CrudBeExph.Auth.Guardian,
      error_handler: CrudBeExphWeb.AuthErrorHandler

    plug Guardian.Plug.VerifyHeader, scheme: "Bearer"
    plug Guardian.Plug.EnsureAuthenticated
    plug CrudBeExphWeb.Plugs.CheckRevoked
    plug CrudBeExphWeb.Plugs.CheckUserActive
  end

  scope "/" do
    get "/health", CrudBeExphWeb.HealthController, :index
    get "/.well-known/jwks.json", CrudBeExphWeb.JwksController, :index
  end

  if System.get_env("ENABLE_TEST_API") == "true" do
    scope "/api/v1/test", CrudBeExphWeb do
      pipe_through :api
