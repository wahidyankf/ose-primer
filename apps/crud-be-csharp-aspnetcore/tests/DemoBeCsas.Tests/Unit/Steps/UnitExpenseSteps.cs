...
/// <summary>
/// Unit-level step bindings for expense management scenarios.
/// Mirrors <c>Integration.Steps.ExpenseSteps</c> but scoped to scenarios tagged
/// <c>@unit</c> and uses <see cref="UnitServiceLayer"/> with in-memory repositories.
/// </summary>
[Binding]
[Trait("Category", "Unit")]
[Scope(Tag = "unit")]
public class UnitExpenseSteps(UnitServiceLayer svc, UnitSharedState state, UnitAuthSteps auth)
{
