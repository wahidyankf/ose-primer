# crud-be-csharp-aspnetcore — C#/ASP.NET Core REST API Backend

C# 12 / ASP.NET Core 10 Minimal APIs implementation of the demo backend REST API. A functional
twin of `crud-be-golang-gin` (Go/Gin), `crud-be-elixir-phoenix` (Elixir Phoenix), `crud-be-fsharp-giraffe`
...
```
apps/crud-be-csharp-aspnetcore/
