...
function LoginContent() {
  ...
  const { isAuthenticated, error: authError, setError: setAuthError } = useAuth();
  ...
  const [successMessage] = useState<string | null>(
    registered === "true" ? "Registration successful. Please log in." : null,
  );

  // Read session expired message from sessionStorage or auth context
  useEffect(() => {
  ...
  const errorMessage = authError ?? getErrorMessage();
  ...
  }, [username, password, authError, setAuthError]);
