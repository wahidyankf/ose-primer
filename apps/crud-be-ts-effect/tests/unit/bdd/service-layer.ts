...
async function runEffect<A>(
  ...
  // Use Effect.either to capture failures as Left values instead of thrown
  // FiberFailure wrappers.  This ensures errorToResponse receives the raw
  ...
  return { ok: false, error: either.left };
}
