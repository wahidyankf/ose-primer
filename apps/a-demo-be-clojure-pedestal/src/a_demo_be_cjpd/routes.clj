(ns a-demo-be-cjpd.routes
  "Pedestal route table definition."
  (:require [io.pedestal.http.route.definition.table :as table]
            [a-demo-be-cjpd.interceptors.json :as json-int]
            [a-demo-be-cjpd.interceptors.auth :as auth-int]
            [a-demo-be-cjpd.interceptors.admin :as admin-int]
            [a-demo-be-cjpd.interceptors.error :as error-int]
            [a-demo-be-cjpd.interceptors.multipart :as multipart-int]
            [a-demo-be-cjpd.handlers.health :as health]
            [a-demo-be-cjpd.handlers.auth :as auth-h]
            [a-demo-be-cjpd.handlers.user :as user-h]
            [a-demo-be-cjpd.handlers.admin :as admin-h]
            [a-demo-be-cjpd.handlers.expense :as expense-h]
            [a-demo-be-cjpd.handlers.attachment :as attachment-h]
            [a-demo-be-cjpd.handlers.report :as report-h]
            [a-demo-be-cjpd.handlers.token :as token-h]
            [a-demo-be-cjpd.handlers.jwks :as jwks-h]
            [a-demo-be-cjpd.handlers.test-api :as test-api-h]))
