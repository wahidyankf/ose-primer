...
var allOKChecks = []ToolCheck{
	...
	{Name: "java", Binary: "java", Status: StatusOK, InstalledVersion: "25", RequiredVersion: "25", Source: "apps/crud-be-fsharp-giraffe-jasb/pom.xml → <java.version>", Note: "required: 25"},
	...
	{Name: "python", Binary: "python3", Status: StatusOK, InstalledVersion: "3.13.1", RequiredVersion: "3.13", Source: "apps/crud-be-python-fastapi/.python-version", Note: "required: \u22653.13"},
	{Name: "rust", Binary: "rustc", Status: StatusOK, InstalledVersion: "1.94.0", RequiredVersion: "1.80", Source: "apps/crud-be-rust-axum/Cargo.toml → rust-version", Note: "required: ≥1.80"},
	...
	{Name: "dotnet", Binary: "dotnet", Status: StatusOK, InstalledVersion: "10.0.103", RequiredVersion: "10.0.103", Source: "apps/crud-be-fsharp-giraffe/global.json → sdk.version", Note: "required: \u226510.0.103 (major)"},
	{Name: "clojure", Binary: "clj", Status: StatusOK, InstalledVersion: "1.12.4.1582", Source: "(no config file)", Note: "no version requirement"},
	{Name: "dart", Binary: "dart", Status: StatusOK, InstalledVersion: "3.11.3", RequiredVersion: "3.11.1", Source: "apps/crud-fe-dart-flutterweb/pubspec.yaml → environment.sdk", Note: "required: \u22653.11.1"},
	{Name: "flutter", Binary: "flutter", Status: StatusOK, InstalledVersion: "3.41.5", RequiredVersion: "3.41.0", Source: "apps/crud-fe-dart-flutterweb/pubspec.yaml → environment.flutter", Note: "required: ≥3.41.0"},
...
func TestFormatMarkdown(t *testing.T) {
	...
	for _, name := range []string{"git", "volta", "node", "npm", "java", "maven", "golang", "python", "rust", "cargo-llvm-cov", "elixir", "erlang", "dotnet", "clojure", "dart", "flutter", "docker", "jq", "playwright"} {
