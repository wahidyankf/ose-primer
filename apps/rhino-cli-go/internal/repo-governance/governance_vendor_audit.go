...
var forbiddenTerms = []struct {
	...
	{regexp.MustCompile(`\bJunie\b`), "Junie", `"the coding agent" or "AI coding assistant"`},
	{regexp.MustCompile(`\bJetBrains\b`), "JetBrains", `"the coding-agent vendor" or drop`},
	{regexp.MustCompile(`Amazon Q\b`), "Amazon Q", `"the coding agent"`},
	{regexp.MustCompile(`\bAntigravity\b`), "Antigravity", `"the coding agent"`},
	{regexp.MustCompile(`Pi Coding Agent`), "Pi Coding Agent", `"the coding agent"`},
	{regexp.MustCompile(`pi\.dev`), "pi.dev", `"the coding agent"`},
	{regexp.MustCompile(`\bEarendil\b`), "Earendil", `"the coding-agent vendor" or drop`},
	...
	{regexp.MustCompile(`\.junie/`), ".junie/", `"the platform binding directory"`},
	{regexp.MustCompile(`\.amazonq/`), ".amazonq/", `"the platform binding directory"`},
	{regexp.MustCompile(`\.pi/`), ".pi/", `"the platform binding directory"`},
	{regexp.MustCompile(`\.gemini/`), ".gemini/", `"the platform binding directory"`},
	{regexp.MustCompile(`\.agent/`), ".agent/", `"the platform binding directory"`},
	{regexp.MustCompile(`\.agents/`), ".agents/", `"the platform binding directory"`},
