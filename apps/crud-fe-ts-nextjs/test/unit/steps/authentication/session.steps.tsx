...
const feature = await loadFeature(
  path.resolve(__dirname, "../../../../../../specs/apps/crud/behavior/crud-web/gherkin/authentication/session.feature"),
);
...
// We'll test session behaviors through the auth provider / components
