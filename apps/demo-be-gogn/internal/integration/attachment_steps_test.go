...
func uploadFile(router interface{ ServeHTTP(http.ResponseWriter, *http.Request) }, path, filename, contentType string, content []byte, token string) (*http.Response, []byte) {
