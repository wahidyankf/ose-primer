...
from crud_be_python_fastapi.auth.jwt_service import get_jwks
...
from crud_be_python_fastapi.routers import (
    admin,
    attachments,
    auth,
    expenses,
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="crud-be-python-fastapi", version="0.1.0", lifespan=lifespan)
