...
from crud_be_python_fastapi.auth.jwt_service import (
    create_access_token,
...
from crud_be_python_fastapi.dependencies import (
    get_attachment_repo,
    get_expense_repo,
    get_revoked_token_repo,
    get_user_repo,
)
from crud_be_python_fastapi.domain.attachment import ALLOWED_CONTENT_TYPES, MAX_ATTACHMENT_SIZE
from crud_be_python_fastapi.domain.errors import (
    AccountLockedError,
    ConflictError,
    FileTooLargeError,
    ForbiddenError,
...
from crud_be_python_fastapi.domain.expense import (
    validate_amount,
    validate_currency,
    validate_unit,
)
...
class ServiceClient:
    ...
    def post_login(self, username: str, password: str) -> FakeResponse:
        ...
        try:
            ...
            from crud_be_python_fastapi.auth.jwt_service import create_refresh_token
