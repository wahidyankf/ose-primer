...
End-to-end tests for all [crud-fe frontends](../../specs/apps/crud/behavior/crud-web/README.md),
...
Feature files in [`specs/apps/crud/behavior/crud-web/gherkin/`](../../specs/apps/crud/behavior/crud-web/gherkin/README.md) are the source of truth:
...
```
specs/apps/crud/behavior/crud-web/gherkin/**/*.feature    <- source of truth (read-only)
        |
