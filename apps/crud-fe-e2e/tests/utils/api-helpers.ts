...
export async function listExpenses(accessToken: string): Promise<Array<{ id: string; description: string }>> {
...
export async function deleteAttachmentApi(accessToken: string, expenseId: string, attachmentId: string): Promise<void> {
