...
void render(Element parent) {
      ...
      resetBtn.addEventListener(
        ...
        ((Event _) {
          () async {
            ...
            final oldTokenAreas = actionsCell.querySelectorAll(
              '[data-reset-token-area]',
            );
  ...
  searchForm.addEventListener(
    ...
    ((Event e) {
      ...
      currentSearch = term;
      currentPage = 0;
      clearBtn.style.setProperty(
        'display',
        term.isEmpty ? 'none' : 'inline-block',
      );
      loadUsers();
    }).toJS,
  );
