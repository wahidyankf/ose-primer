  ...
  fun init() {
    ...
    val url =
      System.getenv("DATABASE_URL")
        ?: "jdbc:postgresql://localhost:5432/crud_be_kotlin_ktor_test?user=crud_be_kotlin_ktor&password=crud_be_kotlin_ktor"

    // Parse user/password from URL query string if embedded (JDBC style with params)
    val user = extractParam(url, "user") ?: System.getenv("DATABASE_USER") ?: "crud_be_kotlin_ktor"
    val password =
      extractParam(url, "password") ?: System.getenv("DATABASE_PASSWORD") ?: "crud_be_kotlin_ktor"
