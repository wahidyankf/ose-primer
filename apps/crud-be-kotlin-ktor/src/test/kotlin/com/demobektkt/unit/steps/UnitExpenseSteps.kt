...
class UnitExpenseSteps {
  ...
  // @covers specs/apps/crud/behavior/crud-be/gherkin/expenses/currency-handling.feature:Expense
  // summary groups totals by currency without cross-currency mixing
