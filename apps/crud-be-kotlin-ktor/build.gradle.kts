...
ktor { fatJar { archiveFileName.set("crud-be-kotlin-ktor-all.jar") } }
...
val specsDir = file("${rootProject.projectDir}/../../specs/apps/crud/behavior/crud-be/gherkin")

if (System.getenv("SKIP_SPEC_COPY") == null && specsDir.exists()) {
  tasks.processTestResources { from(specsDir) { into("specs/apps/crud/behavior/crud-be/gherkin") } }
}
