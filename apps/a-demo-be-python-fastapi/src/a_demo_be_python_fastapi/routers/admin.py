...
from a_demo_be_python_fastapi.auth.dependencies import require_admin
from a_demo_be_python_fastapi.dependencies import get_db, get_user_repo
from a_demo_be_python_fastapi.domain.errors import NotFoundError
...
def disable_user(
    ...
    from a_demo_be_python_fastapi.dependencies import get_revoked_token_repo
