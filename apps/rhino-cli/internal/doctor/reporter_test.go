...
var allOKChecks = []ToolCheck{
	...
	{Name: "java", Binary: "java", Status: StatusOK, InstalledVersion: "25", RequiredVersion: "25", Source: "apps/demo-be-fsharp-giraffe-jasb/pom.xml → <java.version>", Note: "required: 25"},
	...
	{Name: "rust", Binary: "rustc", Status: StatusOK, InstalledVersion: "1.94.0", RequiredVersion: "1.80", Source: "apps/demo-be-rust-axum/Cargo.toml → rust-version", Note: "required: ≥1.80"},
	...
	{Name: "flutter", Binary: "flutter", Status: StatusOK, InstalledVersion: "3.41.5", RequiredVersion: "3.41.0", Source: "apps/demo-fe-dart-flutterweb/pubspec.yaml → environment.flutter", Note: "required: ≥3.41.0"},
