...
var allOKChecks = []ToolCheck{
	...
	{Name: "java", Binary: "java", Status: StatusOK, InstalledVersion: "25", RequiredVersion: "25", Source: "apps/a-demo-be-fsharp-giraffe-jasb/pom.xml → <java.version>", Note: "required: 25"},
