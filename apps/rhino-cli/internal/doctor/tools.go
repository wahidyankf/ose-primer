...
func buildToolDefs(repoRoot string) []toolDef {
	...
	pubspecPath := filepath.Join(repoRoot, "apps", "crud-fe-dart-flutterweb", "pubspec.yaml")
	cargoTomlPath := filepath.Join(repoRoot, "apps", "crud-be-rust-axum", "Cargo.toml")
	...
	return []toolDef{
		...
		},
		{
			name:      "java",
			binary:    "java",
			source:    "apps/crud-be-fsharp-giraffe-jasb/pom.xml → <java.version>",
			args:      []string{"-version"},
		...
		// --- Rust ---
		{
			name:     "rust",
			binary:   "rustc",
			source:   "apps/crud-be-rust-axum/Cargo.toml → rust-version",
			args:     []string{"--version"},
		...
		// --- .NET ---
		{
			name:     "dotnet",
			binary:   "dotnet",
			source:   "apps/crud-be-fsharp-giraffe/global.json → sdk.version",
			args:     []string{"--version"},
		...
		// --- Dart/Flutter ---
		{
			name:       "dart",
			binary:     "dart",
			source:     "apps/crud-fe-dart-flutterweb/pubspec.yaml → environment.sdk",
			args:       []string{"--version"},
		...
		},
		{
			name:     "flutter",
			binary:   "flutter",
			source:   "apps/crud-fe-dart-flutterweb/pubspec.yaml → environment.flutter",
			args:     []string{"--version"},
