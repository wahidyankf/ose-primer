...
Any package that fails either check is reported as a violation.`,
  ...
  rhino-cli java validate-annotations apps/a-demo-be-fsharp-giraffe-jasb/src/main/java

  # Use a custom annotation
  rhino-cli java validate-annotations apps/a-demo-be-fsharp-giraffe-jasb/src/main/java --annotation NonNull

  # Output as JSON
  rhino-cli java validate-annotations apps/a-demo-be-fsharp-giraffe-jasb/src/main/java -o json

  # Output as markdown report
  rhino-cli java validate-annotations apps/a-demo-be-fsharp-giraffe-jasb/src/main/java -o markdown`,
