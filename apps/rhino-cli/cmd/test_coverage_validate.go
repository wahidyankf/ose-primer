...
var validateTestCoverageCmd = &cobra.Command{
	...
	Short: "Check test coverage against a threshold (line-coverage 3-state algorithm)",
	Long: `Compute line coverage using a 3-state algorithm and compare against a threshold.
...
The coverage file path is relative to the git repository root.`,
  ...
  # Check LCOV coverage
  rhino-cli test-coverage validate apps/demo-fe-ts-nextjs/coverage/lcov.info 85
