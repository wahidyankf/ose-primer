//! Spec-coverage reporter — formats scan results as text, JSON, or Markdown.
...
use crate::application::speccoverage::types::{CheckResult, StepGap};
...
mod tests {
    use super::*;
    use crate::application::speccoverage::types::{CoverageGap, ScenarioGap, StepGap as StepGapT};
