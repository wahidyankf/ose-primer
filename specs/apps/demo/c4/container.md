...
graph TD
    ...
    subgraph SPECS["Specifications"]
        ...
        BE_GHERKIN["Backend Gherkin<br/>──────────────────<br/>specs/apps/demo/be/gherkin/<br/><br/>See be/gherkin/README"]:::spec

        FE_GHERKIN["Frontend Gherkin<br/>──────────────────<br/>specs/apps/demo/fe/gherkin/<br/><br/>See fe/gherkin/README"]:::spec
    end
