...
Gherkin feature files for the crud-scale backend service. 14 files, 78 scenarios across 8
domains.
...
| test-support     | `test-support/test-api.feature`          | 2         |
...
- **Parent**: [crud-be specs](../README.md)
