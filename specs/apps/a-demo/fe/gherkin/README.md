...
Each `apps/a-demo-fe-{lang}-{framework}/` (e.g., `a-demo-fe-ts-nextjs`) consumes these specs, just as
`apps/a-demo-be-{lang}-{framework}/` consumes `specs/apps/a-demo/be/gherkin/`. Step definitions
