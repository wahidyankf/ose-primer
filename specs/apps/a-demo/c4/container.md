...
graph TD
    ...
    subgraph SPECS["Specifications"]
        CONTRACT["OpenAPI 3.1 Contract<br/>──────────────────<br/>specs/apps/a-demo/contracts/<br/><br/>Types, endpoints, schemas<br/>Generates code via codegen"]:::spec

        BE_GHERKIN["Backend Gherkin<br/>──────────────────<br/>specs/apps/a-demo/be/gherkin/<br/><br/>See be/gherkin/README"]:::spec

        FE_GHERKIN["Frontend Gherkin<br/>──────────────────<br/>specs/apps/a-demo/fe/gherkin/<br/><br/>See fe/gherkin/README"]:::spec
    end
...
| --------------------------- | ---------- | ------------ | ---------- | -------- |
| a-demo-be-golang-gin        | Go         | Gin          | PostgreSQL | >= 90%   |
| a-demo-be-java-springboot   | Java       | Spring Boot  | PostgreSQL | >= 90%   |
| a-demo-be-java-vertx        | Java       | Vert.x       | PostgreSQL | >= 90%   |
| a-demo-be-kotlin-ktor       | Kotlin     | Ktor         | PostgreSQL | >= 90%   |
| a-demo-be-python-fastapi    | Python     | FastAPI      | PostgreSQL | >= 90%   |
| a-demo-be-rust-axum         | Rust       | Axum         | PostgreSQL | >= 90%   |
| a-demo-be-ts-effect         | TypeScript | Effect       | PostgreSQL | >= 90%   |
| a-demo-be-fsharp-giraffe    | F#         | Giraffe      | PostgreSQL | >= 90%   |
| a-demo-be-csharp-aspnetcore | C#         | ASP.NET Core | PostgreSQL | >= 90%   |
| a-demo-be-clojure-pedestal  | Clojure    | Pedestal     | PostgreSQL | >= 90%   |
| a-demo-be-elixir-phoenix    | Elixir     | Phoenix      | PostgreSQL | >= 90%   |

### Single Page Application (3 implementations)

| App                         | Language   | Framework      | Coverage |
| --------------------------- | ---------- | -------------- | -------- |
| a-demo-fe-ts-nextjs         | TypeScript | Next.js 16     | >= 70%   |
| a-demo-fe-ts-tanstack-start | TypeScript | TanStack Start | >= 70%   |
| a-demo-fe-dart-flutterweb   | Dart       | Flutter Web    | >= 70%   |

### E2E Test Suites

| App           | Targets         | Scope                       |
| ------------- | --------------- | --------------------------- |
| a-demo-be-e2e | All 11 backends | Playwright, per-backend CI  |
| a-demo-fe-e2e | All 3 frontends | Playwright, per-frontend CI |
