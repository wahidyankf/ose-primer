...
nx run a-demo-contracts:lint

# Bundle into single resolved YAML + JSON
nx run a-demo-contracts:bundle

# Generate browsable API documentation
nx run a-demo-contracts:docs
# Open specs/apps/a-demo/contracts/generated/docs/index.html
```
...
2. Run `nx run a-demo-contracts:lint` to validate
3. Run `nx run a-demo-contracts:bundle` to regenerate the bundled spec
...
| --------------------------- | :------------: | :---------------------------: |
| a-demo-be-golang-gin        |      yes       |              yes              |
| a-demo-be-java-springboot   |      yes       |              yes              |
| a-demo-be-java-vertx        |      yes       |              yes              |
| a-demo-be-elixir-phoenix    |      yes       |              yes              |
| a-demo-be-python-fastapi    |      yes       |              yes              |
| a-demo-be-rust-axum         |      yes       |              yes              |
| a-demo-be-fsharp-giraffe    |      yes       |              yes              |
| a-demo-be-ts-effect         |      yes       |              yes              |
| a-demo-be-kotlin-ktor       |      yes       |              yes              |
| a-demo-be-csharp-aspnetcore |      yes       |              yes              |
| a-demo-be-clojure-pedestal  |      yes       |              yes              |
| a-demo-fe-ts-nextjs         |      yes       |              yes              |
| a-demo-fe-ts-tanstack-start |      yes       |              yes              |
| a-demo-fe-dart-flutterweb   |      yes       |              yes              |
