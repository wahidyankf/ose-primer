...
- [File-Touch Discipline](../practice/file-touch-discipline.md) — the touched-file ledger that
  makes "stage only the paths you can account for" actionable, and that survives context compaction
