...
- [Hexagonal Architecture — CLI Apps](./hexagonal-architecture-cli.md) - Layer conventions for `rhino-cli` (Rust)
...
- [OpenAPI Contract-First Development](./openapi-contract-first.md) - Contract-first workflow with single OpenAPI source of truth, codegen targets for all 11 BE apps, and drift detection
