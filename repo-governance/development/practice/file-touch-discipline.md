...
(see [Bare-Repo Landing Method](../workflow/bare-repo-landing-method.md#terminal-reconcile)), say so
explicitly and escalate — do not keep deferring to it silently across sessions.
