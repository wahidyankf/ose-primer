...
| BE Gherkin Specs | `specs/apps/crud/behavior/be/gherkin/README.md`  |
| FE Gherkin Specs | `specs/apps/crud/behavior/web/gherkin/README.md` |
...
**agent skills Infrastructure**: Agents leverage 34 skills providing two modes:
```
