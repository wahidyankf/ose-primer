...
- [ ] By-example tutorial follows [By Example Convention]
- [ ] In-practice guides follow [Programming Language Content Standard]
...
- [Programming Language Content Standard] - Full Set Tutorial Package for programming languages (ayokoding-web follows this)
- [By Example Tutorial] - Code-first tutorial standards (Component 3 of Full Set)
- [Tutorial Naming] - Tutorial type standards and naming patterns
