...
- [Plans Organization](./plans.md) - Standards for organizing project planning documents in plans/ folder including structure (ideas.md, backlog/, in-progress/, done/), naming patterns (YYYY-MM-DD\_\_identifier/), lifecycle stages, project identifiers, [execution markers (`[AI]`/`[HUMAN]`)](./plans.md#execution-markers-ai-vs-human), and [phase gates with natural pauses](./plans.md#phase-gates-and-natural-pauses-hard-rule)
