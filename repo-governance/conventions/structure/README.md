...
- [Repository Ecosystem Convention](./repository-ecosystem.md) - The three sibling OSE repositories (`ose-public`, `ose-primer`, `ose-private`), their roles, propagation rules, and verification steps. Replaces the deleted `ose-projects` umbrella as the canonical description of the family relationship
