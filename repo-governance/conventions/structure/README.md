...
- [Repository Ecosystem Convention](./repository-ecosystem.md) - The four sibling OSE repositories (`ose-public`, `ose-primer`, `ose-private`, `beaver-nest`), their roles, propagation rules, and verification steps. Replaces the deleted `ose-projects` umbrella as the canonical description of the family relationship
