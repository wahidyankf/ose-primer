...
- [Repository Ecosystem Convention](./structure/repository-ecosystem.md) - The three sibling OSE repositories (`ose-public`, `ose-primer`, `ose-private`), their roles, propagation rules, and verification steps
