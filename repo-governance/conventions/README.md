...
- [Multi-Harness Binding](./structure/multi-harness-binding.md) - Two-tier strategy for keeping the repo compatible with many coding-agent harnesses (AGENTS.md-canonical, no-shadowing, mechanical generation)
...
- [Repository Ecosystem Convention](./structure/repository-ecosystem.md) - The four sibling OSE repositories (`ose-public`, `ose-primer`, `ose-private`, `beaver-nest`), their roles, propagation rules, and verification steps
