...
| [Plan Establishment](./plan/plan-establishment-execution.md)                                                              | Transform a user prompt into a production-ready plan: repo exploration → grill → web research → grill → plan-maker → plan-quality-gate → push                                                                                                                                                                                                                                                                                                             | plan-maker, web-researcher, plan-checker, plan-fixer                                                  | High       |
...
| [Repository Dependency Bump Planning](./repo/repo-dependency-bump-planning.md)                                            | Survey every dependency manifest (npm, Cargo, .NET, Go, Docker, GitHub Actions), classify each candidate bump per the Dependency Bump Stability & Safety Policy, and author a validated backlog plan via plan-establishment-execution. Never edits a manifest                                                                                                                                                                                             | web-researcher, plan-maker, plan-checker, plan-fixer                                                  | High       |
