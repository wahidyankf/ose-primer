...
| [Cross-Vendor Parity Quality Gate](./repo/repo-cross-vendor-parity-quality-gate.md)                                       | Validate cross-vendor behavioral-parity invariants and apply fixes iteratively until zero findings                                                                        | repo-parity-checker, repo-parity-fixer                                                   | Medium     |
| [Harness Compatibility Quality Gate](./repo/repo-harness-compatibility-quality-gate.md)                                   | Detect external drift between supported coding-agent harnesses' upstream config conventions and the platform-bindings catalog/binding files, apply fixes until zero drift | repo-harness-compatibility-checker, repo-harness-compatibility-fixer                     | Medium     |
