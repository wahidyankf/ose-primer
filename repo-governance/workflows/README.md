...
| [Plan Handover Execution](./plan/plan-handover-execution.md)                                                              | Write a structured handover document (`local-tmp/handovers/<date>__<plan-identifier>-implementation.md`) capturing an in-progress plan's per-repo state, concrete next step, and non-obvious gotchas learned this session, for a different agent or session to resume from. Local, gitignored, single-machine artifact; read by plan-takeover-execution as a lead, never a substitute for its own verification                                                                                                    | none — direct orchestration                                                                           | Low        |
| [Plan Takeover Execution](./plan/plan-takeover-execution.md)                                                              | Given a plan path, discover its true execution state across the current repo and its siblings (`ose-public`, `ose-private` at minimum) — worktrees, local/remote branches, PRs — reconcile findings, take over any live in-flight work, clean up confirmed-stale leftover worktrees/branches/build artifacts, then hand off to plan-execution                                                                                                                                                                     | none — direct orchestration, hands off to plan-execution-checker                                      | Medium     |
