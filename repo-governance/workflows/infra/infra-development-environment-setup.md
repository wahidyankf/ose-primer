...
title: "infra-development-environment-setup"
...
| 5   | golang     | >= go.mod directive   | apps/crud-be-golang-gin/go.mod         | Brew/asdf      |
...
Required for: `crud-be-golang-gin`, `libs/golang-commons`
...
The required minimum version is specified in `apps/crud-be-golang-gin/go.mod`. As of this writing,
Go >= 1.26.
...
rhino-cli env restore --force --include-config
```
