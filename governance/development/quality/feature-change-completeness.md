...
1. `specs/apps/demo/contracts/` -- add path and response schema
2. `specs/apps/demo/be/gherkin/products/get-product.feature` -- add scenarios
...
1. `specs/apps/demo/contracts/` -- remove path definition
2. `specs/apps/demo/be/gherkin/products/delete-product.feature` -- remove scenarios
