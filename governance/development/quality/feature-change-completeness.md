...
1. `specs/apps/crud/contracts/` -- add path and response schema
2. `specs/apps/crud/be/gherkin/products/get-product.feature` -- add scenarios
...
6. `specs/apps/crud/c4/` -- update component diagram if new component
...
1. `specs/apps/crud/contracts/` -- remove path definition
2. `specs/apps/crud/be/gherkin/products/delete-product.feature` -- remove scenarios
