...
CSS and Tailwind v4 conventions for all frontend applications in the open-sharia-enterprise monorepo. These rules govern how styles are written, organized, and maintained across `organiclever-fe`, `ayokoding-fs`, `a-demo-fe-ts-nextjs`, and `a-demo-fs-ts-nextjs`.
