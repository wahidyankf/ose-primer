...
- [Per-Directory Licensing](./structure/licensing.md) - Standards for the per-directory licensing strategy using FSL-1.1-MIT for product apps and MIT for shared libraries and reference implementations. Defines LICENSE file placement rules, template requirements, copyright notice format, and rules for new directories
