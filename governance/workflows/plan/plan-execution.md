...
1. **Match by project/app name**: If the checklist item names a specific app (e.g., `demo-be-java-vertx`), use the agent for that app's language (e.g., `swe-java-dev`). Refer to [CLAUDE.md](../../../CLAUDE.md) for the full app list and their tech stacks.
