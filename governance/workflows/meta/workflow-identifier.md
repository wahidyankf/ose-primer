...
- **Args**: `action: build, project: a-demo-fs-ts-nextjs`
...
- Content quality assurance (plan-quality-gate, a-demo-fs-ts-nextjs-content-quality-gate)
...
inputs:
  - name: content-type
    type: enum
    values: [docs, a-demo, ose-platform, readme]
    required: true
  - name: scope
    type: string
    required: true
