---
name: ayokoding-fs-in-the-field-quality-gate
...
outputs:
  ...
  - name: checker-report
    type: file
    pattern: generated-reports/ayokoding-fs-in-the-field__*__*__audit.md
    description: Final validation report from apps-ayokoding-fs-in-the-field-checker (4-part format with UUID chain)
  - name: fixer-report
    type: file
    pattern: generated-reports/ayokoding-fs-in-the-field__*__*__fix.md
    description: Final fixes report from apps-ayokoding-fs-in-the-field-fixer (4-part format with UUID chain)
...
- Before publishing in-the-field content to ayokoding-fs
...
**Preferred Mode**: Agent Delegation — invoke `apps-ayokoding-fs-in-the-field-checker` and
`apps-ayokoding-fs-in-the-field-fixer` via the Agent tool with `subagent_type`
...
```
User: "Run ayokoding-fs in-the-field quality gate workflow for java/in-the-field/"
```

The AI will:

1. Invoke `apps-ayokoding-fs-in-the-field-checker` via the Agent tool (validates guides, writes audit)
2. User reviews audit report and decides on fixes (manual decision point)
3. Invoke `apps-ayokoding-fs-in-the-field-fixer` via the Agent tool (reads audit, applies fixes, writes fix report)
...
```
User: "Run ayokoding-fs in-the-field quality gate workflow for java/in-the-field/ in manual mode"
```
...
graph TB
    ...
    A -->|apps-ayokoding-fs-in-the-field-maker or manual| B
    B -->|apps-ayokoding-fs-in-the-field-checker| C
    C -->|Issues found| D
    D -->|apps-ayokoding-fs-in-the-field-fixer| B
...
**Option B: AI-assisted creation** (apps-ayokoding-fs-in-the-field-maker)
...
**Agent**: `apps-ayokoding-fs-in-the-field-checker`

**Execution**:

```bash
# Invoke via Task tool
subagent_type: apps-ayokoding-fs-in-the-field-checker
prompt: "Validate apps/ayokoding-fs/content/en/learn/software-engineering/programming-language/java/in-the-field/ for compliance with in-the-field standards"
```
...
**Agent**: `apps-ayokoding-fs-in-the-field-fixer`

**Execution**:

```bash
# Invoke via Task tool with audit report and mode parameter
subagent_type: apps-ayokoding-fs-in-the-field-fixer
...
- **ayokoding-fs-by-example-quality-gate**: Specialized for by-example tutorials
- **ayokoding-fs-in-the-field-quality-gate** (this workflow): Specialized for in-the-field production guides
...
- **[`apps-ayokoding-fs-in-the-field-checker` agent](../../../.claude/agents/apps-ayokoding-fs-in-the-field-checker.md)**: Validation agent
- **[`apps-ayokoding-fs-in-the-field-fixer` agent](../../../.claude/agents/apps-ayokoding-fs-in-the-field-fixer.md)**: Fixing agent
- **[`apps-ayokoding-fs-in-the-field-maker` agent](../../../.claude/agents/apps-ayokoding-fs-in-the-field-maker.md)**: Content creation agent
