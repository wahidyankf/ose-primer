defmodule ElixirCabbage.Mixfile do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Story BDD tool for Elixir/ExUnit (OSE fork of cabbage-ex/cabbage 0.4.1)",
      deps: deps(),
      aliases: aliases(),
  ...
  defp deps do
    [
      # Local path dep — replaces upstream {:gherkin, "~> 2.0"} (hex package).
      {:elixir_gherkin, path: "../../libs/elixir-gherkin"},
