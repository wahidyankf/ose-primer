...
### rhino-cli Module Structure (Rust)

rhino-cli provides `links check` for validating internal links in crud-fs-ts-nextjs content, alongside its repository-automation and binding-generation commands.
