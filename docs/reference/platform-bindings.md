...
| Cursor                                                  | Yes                                                                                                                                                                                    | `.cursor/rules/*.mdc` (+ legacy `.cursorrules`)                                                                | `.cursor/mcp.json`                                                                              | `.cursor/agents/*.md` (generated from `.claude/agents/`)                                                            | `.cursor/skills/`                         | Absent (generated agent surface; rules not shipped)      |
