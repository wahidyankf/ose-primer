...
`rhino-cli agents validate-bindings` (both implemented identically in the Rust and Go CLIs and
held byte-identical by the shadow-diff parity gate). The `validate-bindings` command is also wired
