...
| `<lang>` gate (one job per affected language) | `nx affected -t test:quick --parallel=$P` — each affected project runs typecheck → lint → test:unit → test:coverage (≥90% line) → test:specs. No `format:check`, no `test:integration`, no `test:e2e`, no `deps:audit` (uncacheable → CRON-only).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | affected projects                                                                   |
