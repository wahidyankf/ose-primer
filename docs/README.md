...
This directory contains comprehensive documentation for the open-sharia-enterprise repository, organized using the [Diátaxis framework](https://diataxis.fr/).
...
- Helps users find the right documentation for their needs
...
- [Documentation Conventions](../repo-governance/conventions/README.md) - File naming, linking, and organization standards
- [Development Practices](../repo-governance/development/README.md) - Development practices, tools, and workflows
