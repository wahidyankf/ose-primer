---
title: Java Performance Standards for demo
...
# Java Performance Standards for demo
...
Performance in demo is critical for:
...
**REQUIRED**: All demo services MUST meet the following latency targets (p95).
...
**REQUIRED**: demo services MUST support minimum throughput targets.
