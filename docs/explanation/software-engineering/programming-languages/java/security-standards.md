---
title: Java Security Standards for demo
...
# Java Security Standards for demo
...
Security in demo protects critical assets:
...
**REQUIRED**: All demo APIs MUST use OAuth2 with JWT tokens for authentication.
...
**REQUIRED**: Only pre-approved libraries MAY be used in demo.
...
**REQUIRED**: demo MUST undergo annual penetration testing.
