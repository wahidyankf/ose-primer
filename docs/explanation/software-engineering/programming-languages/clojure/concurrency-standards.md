...
description: Authoritative demo Clojure concurrency standards (atoms, refs, agents, core.async)
...
This document defines authoritative concurrency standards for Clojure development in demo. Clojure's four concurrency primitives (atoms, refs, agents, vars) and core.async channels provide safe concurrency with immutable data at their core.

**Target Audience**: demo Clojure developers working on concurrent and asynchronous systems
