...
**MUST** enable Link-Time Optimization in release profile (see [Build Configuration Standards](./ex-soen-prla-rs__build-configuration.md)):
...
- [Concurrency Standards](./ex-soen-prla-rs__concurrency-standards.md) - Rayon for data parallelism
- [Memory Management Standards](./ex-soen-prla-rs__memory-management-standards.md) - Smart pointer costs
- [Build Configuration](./ex-soen-prla-rs__build-configuration.md) - Release profile settings
