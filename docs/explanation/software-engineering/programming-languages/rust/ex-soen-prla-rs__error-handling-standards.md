...
- [Coding Standards](./ex-soen-prla-rs__coding-standards.md) - Idiomatic Rust patterns
- [Type Safety Standards](./ex-soen-prla-rs__type-safety-standards.md) - Algebraic types for error modeling
- [API Standards](./ex-soen-prla-rs__api-standards.md) - HTTP error response mapping
