...
**MUST** use `Arc<T>` (not `Rc<T>`) for shared ownership across threads or async tasks. See [Concurrency Standards](./ex-soen-prla-rs__concurrency-standards.md).
...
- [Concurrency Standards](./ex-soen-prla-rs__concurrency-standards.md) - Arc, Mutex in async
- [Performance Standards](./ex-soen-prla-rs__performance-standards.md) - Allocation patterns
- [Type Safety Standards](./ex-soen-prla-rs__type-safety-standards.md) - Smart pointers and generics
