...
**SHOULD** use the sealed trait pattern to prevent external types from implementing internal traits (see also [DDD Standards](./ex-soen-prla-rs__ddd-standards.md)):
...
- [Coding Standards](./ex-soen-prla-rs__coding-standards.md) - Newtype pattern for value objects
- [DDD Standards](./ex-soen-prla-rs__ddd-standards.md) - Domain type modeling
- [Error Handling Standards](./ex-soen-prla-rs__error-handling-standards.md) - Error types as algebraic types
- [Memory Management Standards](./ex-soen-prla-rs__memory-management-standards.md) - Smart pointers in generic code
