...
description: Authoritative demo Rust security standards (memory safety, cargo audit, secrecy crate, safe code)
...
This document defines **authoritative security standards** for Rust development in the demo. Rust's memory safety model eliminates entire classes of vulnerabilities that affect C/C++ and other languages.

**Target Audience**: demo Rust developers, security reviewers
