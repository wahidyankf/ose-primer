...
- [Security Standards](./ex-soen-prla-rs__security-standards.md) - cargo audit, secrets management
- [Build Configuration](./ex-soen-prla-rs__build-configuration.md) - Cargo.toml, CI integration
- [Coding Standards](./ex-soen-prla-rs__coding-standards.md) - Naming and idioms
