...
- [Error Handling Standards](./ex-soen-prla-rs__error-handling-standards.md) - AppError design
- [Concurrency Standards](./ex-soen-prla-rs__concurrency-standards.md) - Arc/Mutex for AppState
- [Security Standards](./ex-soen-prla-rs__security-standards.md) - Auth middleware, input validation
- [DDD Standards](./ex-soen-prla-rs__ddd-standards.md) - Service layer design
