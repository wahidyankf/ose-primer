...
- [Coding Standards](./ex-soen-prla-rs__coding-standards.md) - Newtype pattern
- [Type Safety Standards](./ex-soen-prla-rs__type-safety-standards.md) - Phantom types, sealed traits
- [Error Handling Standards](./ex-soen-prla-rs__error-handling-standards.md) - Domain error types
- [API Standards](./ex-soen-prla-rs__api-standards.md) - Mapping domain types to API responses
