...
- [Error Handling Standards](./ex-soen-prla-rs__error-handling-standards.md) - Result/Option patterns
- [Type Safety Standards](./ex-soen-prla-rs__type-safety-standards.md) - Generics, traits, phantom types
- [Testing Standards](./ex-soen-prla-rs__testing-standards.md) - cargo test, coverage
