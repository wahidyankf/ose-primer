...
- [API Standards](./ex-soen-prla-fs__api-standards.md) - Giraffe route-level auth integration
- [Error Handling Standards](./ex-soen-prla-fs__error-handling-standards.md) - Validation errors as Result types
- [Type Safety Standards](./ex-soen-prla-fs__type-safety-standards.md) - Single-case DUs and type-driven security
