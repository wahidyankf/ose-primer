...
- [Testing Standards](./ex-soen-prla-fs__testing-standards.md) - Expecto test organization mirroring module structure
- [Code Quality Standards](./ex-soen-prla-fs__code-quality-standards.md) - Fantomas and FSharpLint configuration
- [DDD Standards](./ex-soen-prla-fs__ddd-standards.md) - Domain modeling with discriminated unions
- [Type Safety Standards](./ex-soen-prla-fs__type-safety-standards.md) - Single-case DUs and units of measure
