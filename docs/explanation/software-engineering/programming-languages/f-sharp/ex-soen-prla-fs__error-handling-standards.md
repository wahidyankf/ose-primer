...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Discriminated union modeling that error types use
- [Functional Programming Standards](./ex-soen-prla-fs__functional-programming-standards.md) - Monadic composition and Result CEs
- [API Standards](./ex-soen-prla-fs__api-standards.md) - Mapping domain Result errors to HTTP responses
