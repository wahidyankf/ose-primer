...
description: Authoritative demo F# coding standards — naming, module organization, pipeline idioms, discriminated unions
...
**This document is demo-specific**, not an F# tutorial. We define HOW to apply F# in THIS codebase, not WHAT F# is.

## Purpose

This document defines **authoritative coding standards** for F# development in demo. These are prescriptive rules that MUST be followed across all F# projects to ensure consistency, maintainability, and alignment with platform architecture.

**Target Audience**: demo F# developers, technical reviewers, automated code quality tools

**Scope**: demo naming conventions, module organization, pipeline idioms, discriminated union modeling, and anti-patterns to avoid
