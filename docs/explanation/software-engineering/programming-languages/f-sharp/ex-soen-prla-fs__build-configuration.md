...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Module structure that drives file ordering
- [Code Quality Standards](./ex-soen-prla-fs__code-quality-standards.md) - Fantomas pinned in `.config/dotnet-tools.json`
- [Testing Standards](./ex-soen-prla-fs__testing-standards.md) - Test project also follows ordering rules
