...
- [Error Handling Standards](./ex-soen-prla-fs__error-handling-standards.md) - asyncResult CE for async + Result
- [Performance Standards](./ex-soen-prla-fs__performance-standards.md) - Tail recursion in MailboxProcessor loops
- [API Standards](./ex-soen-prla-fs__api-standards.md) - Async Giraffe handlers
