...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Naming conventions FSharpLint enforces
- [Build Configuration](./ex-soen-prla-fs__build-configuration.md) - `.fsproj` and `Directory.Build.props` setup
- [Testing Standards](./ex-soen-prla-fs__testing-standards.md) - Test files also subject to Fantomas
