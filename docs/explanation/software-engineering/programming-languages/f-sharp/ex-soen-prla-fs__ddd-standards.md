...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Discriminated union modeling basics
- [Type Safety Standards](./ex-soen-prla-fs__type-safety-standards.md) - Single-case DUs and type providers
- [Error Handling Standards](./ex-soen-prla-fs__error-handling-standards.md) - Result type in domain transitions
