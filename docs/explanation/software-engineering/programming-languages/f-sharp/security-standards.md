...
description: Authoritative demo F# security standards — type-driven validation, Giraffe auth, parameterized queries
...
This document defines **authoritative security standards** for F# development in demo. F# type system enables security-by-construction: invalid and dangerous inputs are rejected at the type level before reaching business logic.

**Target Audience**: demo F# developers building web services and data pipelines
