...
description: Authoritative demo F# code quality standards — Fantomas formatter, FSharpLint, compiler warnings as errors
...
This document defines **authoritative code quality standards** for F# development in demo. Fantomas is MANDATORY and non-negotiable. Compiler warnings are treated as errors. Incomplete pattern matches MUST be resolved, never suppressed.

**Target Audience**: demo F# developers, CI/CD pipeline configuration, code reviewers
