...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Discriminated unions and pipeline usage
- [Error Handling Standards](./ex-soen-prla-fs__error-handling-standards.md) - Computation expressions for Result
- [DDD Standards](./ex-soen-prla-fs__ddd-standards.md) - Functional aggregate pattern
