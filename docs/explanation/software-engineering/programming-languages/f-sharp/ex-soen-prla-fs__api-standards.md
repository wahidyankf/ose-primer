...
- [Error Handling Standards](./ex-soen-prla-fs__error-handling-standards.md) - Result to HTTP mapping
- [Security Standards](./ex-soen-prla-fs__security-standards.md) - Auth middleware in Giraffe pipeline
- [Testing Standards](./ex-soen-prla-fs__testing-standards.md) - Integration testing Giraffe handlers
