...
- [Concurrency Standards](./ex-soen-prla-fs__concurrency-standards.md) - `Array.Parallel.map` for parallel performance
- [Functional Programming Standards](./ex-soen-prla-fs__functional-programming-standards.md) - Seq composition for lazy evaluation
