...
description: Authoritative demo F# performance standards — tail recursion, struct DUs, BenchmarkDotNet, AltCover profiling
...
This document defines **authoritative performance standards** for F# development in demo. Performance optimization follows the principle: make it work → make it right → make it fast. Premature optimization is prohibited. Measure first, optimize second.

**Target Audience**: demo F# developers working on performance-sensitive components
