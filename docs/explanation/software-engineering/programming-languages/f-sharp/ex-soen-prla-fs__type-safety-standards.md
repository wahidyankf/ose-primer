...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Discriminated union and record basics
- [DDD Standards](./ex-soen-prla-fs__ddd-standards.md) - Making illegal states unrepresentable in domain modeling
- [Security Standards](./ex-soen-prla-fs__security-standards.md) - Single-case DUs for type-driven security
