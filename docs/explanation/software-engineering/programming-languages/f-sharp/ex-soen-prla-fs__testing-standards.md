...
- [Coding Standards](./ex-soen-prla-fs__coding-standards.md) - Module organization that test files mirror
- [Code Quality Standards](./ex-soen-prla-fs__code-quality-standards.md) - Fantomas formats test files too
- [Functional Programming Standards](./ex-soen-prla-fs__functional-programming-standards.md) - Property-based testing for monadic compositions
