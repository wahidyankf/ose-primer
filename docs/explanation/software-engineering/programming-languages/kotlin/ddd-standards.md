...
description: Authoritative demo Kotlin Domain-Driven Design standards (value objects, sealed states, aggregates, domain events)
...
**This document is demo-specific**, not a Kotlin tutorial. We define HOW to apply Domain-Driven Design in THIS codebase.

## Purpose

This document defines **authoritative Domain-Driven Design standards** for Kotlin development in the demo. It covers Value Objects with data classes, sealed classes for domain states, Entity identity, Aggregate invariant enforcement, Repository interfaces, Domain Events, and functional domain modeling.

**Target Audience**: demo Kotlin developers, domain architects, technical reviewers
