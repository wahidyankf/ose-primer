...
description: Authoritative build and deployment standards for Go projects in the demo
...
**This document is demo-specific**, not a Go tutorial.
...
This document defines **authoritative build and configuration standards** for Go development in the demo. These rules ensure consistent, reproducible builds across all environments and developers.

**Target Audience**: demo Go developers configuring builds, CI/CD pipelines, and deployments.
