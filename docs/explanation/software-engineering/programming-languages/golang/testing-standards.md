...
**This document is demo-specific**, not a Go tutorial. It assumes:
...
If you need to learn Go fundamentals first, visit the demo Go learning path.

## 🎯 Purpose

This document defines **authoritative testing standards** for Go development in the demo. These are prescriptive rules that MUST be followed across all Go projects to ensure consistent, maintainable, and reliable test suites.

**Target Audience**: demo Go developers, technical reviewers, QA engineers
