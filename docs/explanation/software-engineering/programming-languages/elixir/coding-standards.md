...
description: Authoritative demo Elixir coding standards (idioms, best practices, anti-patterns to avoid)
...
This document defines **authoritative coding standards** for Elixir development in the demo. These are prescriptive rules that MUST be followed across all Elixir projects to ensure consistency, maintainability, and alignment with platform architecture.

**Target Audience**: demo Elixir developers, technical reviewers, automated code quality tools

**Scope**: demo idioms, naming conventions, OTP patterns, best practices, and anti-patterns to avoid
