...
description: Prescriptive performance requirements for BEAM VM-based financial systems in demo
...
**This document is demo-specific**, not an Elixir tutorial. We define HOW to apply Elixir in THIS codebase, not WHAT Elixir is.

## Purpose

This document defines **authoritative performance standards** for Elixir development in the demo. These standards ensure BEAM VM-based systems meet latency, throughput, and resource efficiency requirements for Shariah-compliant financial applications.

**Target Audience**: demo Elixir developers optimizing for production performance
...
**REQUIRED**: All demo Elixir services MUST meet the following latency targets (p95).
