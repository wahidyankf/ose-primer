...
description: Authoritative demo Dart domain-driven design standards (aggregates, value-objects, repositories)
...
**This document is demo-specific**, not a Dart tutorial. We define HOW to implement Domain-Driven Design in THIS codebase, not WHAT DDD is.

## Purpose

This document defines **authoritative DDD standards** for Dart development in the demo. Sharia-compliant financial domains (Zakat, Murabaha) require rich domain models with enforced invariants.

**Target Audience**: demo Dart developers implementing domain models for Zakat calculation, Murabaha contracts, and Islamic finance
