...
description: Authoritative demo C# performance standards (Span<T>, ArrayPool, BenchmarkDotNet, dotnet-trace profiling, IAsyncEnumerable)
...
This document defines **authoritative performance standards** for C# in the demo.

**Target Audience**: demo C# developers optimizing memory usage or CPU-bound paths
