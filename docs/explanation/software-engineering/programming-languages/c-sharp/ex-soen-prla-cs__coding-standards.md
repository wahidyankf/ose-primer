...
- [Testing Standards](./ex-soen-prla-cs__testing-standards.md) - xUnit, FluentAssertions, Moq patterns
- [Code Quality Standards](./ex-soen-prla-cs__code-quality-standards.md) - Roslyn, dotnet format, editorconfig
- [Type Safety Standards](./ex-soen-prla-cs__type-safety-standards.md) - Nullable reference types, generics, pattern matching
- [DDD Standards](./ex-soen-prla-cs__ddd-standards.md) - Value Objects with records, Aggregate roots
