...
description: Authoritative demo C# build configuration standards (.csproj, Directory.Build.props, NuGet Central Package Management)
...
This document defines **authoritative build configuration standards** for C# projects in the demo.

**Target Audience**: demo C# developers and DevOps engineers
