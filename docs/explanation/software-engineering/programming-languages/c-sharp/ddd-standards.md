...
description: Authoritative demo C# Domain-Driven Design standards (Value Objects with records, Aggregate roots, Domain Events, Clean Architecture)
...
This document defines **authoritative Domain-Driven Design standards** for C# in the demo.

**Target Audience**: demo C# developers modeling Sharia-compliant financial domain
