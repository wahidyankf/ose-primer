...
- [Concurrency Standards](./ex-soen-prla-cs__concurrency-standards.md) - ValueTask<T> for hot paths, Parallel.ForEachAsync
- [Coding Standards](./ex-soen-prla-cs__coding-standards.md) - Struct vs record struct decisions
