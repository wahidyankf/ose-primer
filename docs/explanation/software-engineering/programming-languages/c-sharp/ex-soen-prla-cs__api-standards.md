...
**MUST** return ProblemDetails for all error responses. See [Error Handling Standards](./ex-soen-prla-cs__error-handling-standards.md) for global exception handler setup.
...
- [Error Handling Standards](./ex-soen-prla-cs__error-handling-standards.md) - ProblemDetails exception handler
- [Security Standards](./ex-soen-prla-cs__security-standards.md) - Authentication, authorization, input validation
- [Framework Integration](./ex-soen-prla-cs__framework-integration.md) - Middleware pipeline, DI registration
