...
- [Coding Standards](./ex-soen-prla-cs__coding-standards.md) - Naming, idioms
- [Testing Standards](./ex-soen-prla-cs__testing-standards.md) - xUnit, coverage collection
- [Build Configuration](./ex-soen-prla-cs__build-configuration.md) - Directory.Build.props, csproj setup
- [Type Safety Standards](./ex-soen-prla-cs__type-safety-standards.md) - Nullable reference types deep dive
