...
- [DDD Standards](./ex-soen-prla-cs__ddd-standards.md) - Aggregate and Value Object design for EF Core mapping
- [API Standards](./ex-soen-prla-cs__api-standards.md) - Minimal API endpoint groups
- [Security Standards](./ex-soen-prla-cs__security-standards.md) - Authentication middleware placement
