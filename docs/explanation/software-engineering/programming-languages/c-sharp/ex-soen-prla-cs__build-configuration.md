...
- [Code Quality Standards](./ex-soen-prla-cs__code-quality-standards.md) - Roslyn analyzers in Directory.Build.props
- [Testing Standards](./ex-soen-prla-cs__testing-standards.md) - Test project configuration
- [Framework Integration](./ex-soen-prla-cs__framework-integration.md) - EF Core migration commands
