...
- [Coding Standards](./ex-soen-prla-cs__coding-standards.md) - Record types, immutability patterns
- [Framework Integration](./ex-soen-prla-cs__framework-integration.md) - EF Core owned entities for value objects
- [API Standards](./ex-soen-prla-cs__api-standards.md) - CQRS with MediatR
