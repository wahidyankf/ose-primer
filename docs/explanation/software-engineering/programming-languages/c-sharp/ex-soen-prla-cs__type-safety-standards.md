...
**MUST** enable nullable reference types for all projects (see [Code Quality Standards](./ex-soen-prla-cs__code-quality-standards.md)).
...
- [Coding Standards](./ex-soen-prla-cs__coding-standards.md) - Record types, pattern matching idioms
- [Code Quality Standards](./ex-soen-prla-cs__code-quality-standards.md) - Nullable reference type enforcement
- [DDD Standards](./ex-soen-prla-cs__ddd-standards.md) - Value Objects and strongly-typed IDs
