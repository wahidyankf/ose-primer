...
public class LoggingAspect {
  ...
  @Before("execution(* com.demo.zakat.service.*.*(..))")
  public void logBefore(JoinPoint joinPoint) {
    logger.info("Entering method: {}", joinPoint.getSignature().toShortString());
  }

  @AfterReturning(
    pointcut = "execution(* com.demo.zakat.service.*.*(..))",
    returning = "result"
  )
...
public class PointcutExamples {
  ...
  @Pointcut("execution(com.demo.zakat.dto.ZakatCalculationResponse *(..))")
...
public class ValidationAspect {
  ...
  @Before("execution(* com.demo.donation.service.*.processDonation(..))")
...
public class PerformanceMonitoringAspect {
  ...
  @Around("execution(* com.demo.murabaha.service.*.*(..))")
...
public class MetricsAspect {
  ...
  @Around("execution(* com.demo.zakat.service.*.*(..))")
