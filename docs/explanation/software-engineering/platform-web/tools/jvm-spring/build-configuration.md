...
description: Authoritative demo Maven build standards for Spring Framework projects (POM structure, dependency management, Spring-specific plugins)
...
This document defines **authoritative build configuration standards** for Spring Framework (non-Boot) projects in demo. These prescriptive rules govern Maven POM structure, Spring dependency management, plugin configuration, and multi-module organization.

**Target Audience**: demo Spring Framework developers, build engineers, DevOps teams
