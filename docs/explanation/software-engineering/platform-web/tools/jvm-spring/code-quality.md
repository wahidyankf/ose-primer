...
description: Authoritative demo code quality standards for Spring Framework projects (Spotless, Error Prone, NullAway, ArchUnit for layer boundaries)
...
**This document is demo-specific**, not a Spring Framework tutorial.

## Purpose

This document defines **authoritative code quality standards** for Spring Framework projects in demo. These prescriptive rules govern code formatting (Spotless), compile-time bug detection (Error Prone), null safety (NullAway), and architectural enforcement (ArchUnit).

**Target Audience**: demo Spring Framework developers, CI/CD engineers
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        <compilerArgs>
          <arg>-XDcompilePolicy=simple</arg>
          <arg>-Xplugin:ErrorProne -Xep:NullAway:ERROR -XepOpt:NullAway:AnnotatedPackages=com.demo</arg>
        </compilerArgs>
        <annotationProcessorPaths>
          <path>
            <groupId>com.google.errorprone</groupId>
...
class ArchitectureTest {
  ...
  private static final JavaClasses classes =
      new ClassFileImporter().importPackages("com.demo.zakat");
