...
**REQUIRED**: Complete [AyoKoding Domain-Driven Design](../../../../../apps/ayokoding-fs/content/en/learn/software-engineering/architecture/domain-driven-design-ddd/) before using these standards.
