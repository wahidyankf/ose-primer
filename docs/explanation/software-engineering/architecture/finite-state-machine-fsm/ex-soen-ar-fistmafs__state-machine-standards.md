...
**REQUIRED**: Complete [AyoKoding FSM](../../../../../apps/ayokoding-fs/content/en/learn/software-engineering/architecture/finite-state-machine-fsm/) before using these standards.
