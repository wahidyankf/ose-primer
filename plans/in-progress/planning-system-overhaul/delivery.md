...
- [ ] Update `plans/done/README.md` — add a link entry for `2026-05-26__planning-system-overhaul`
      with title "Planning System Overhaul", summary "TDD HARD RULE, AGENTS.md catalog completeness,
      markdown archive exclusions", and completion date 2026-05-26
