...
| Area             | Detail                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------ |
| **In scope**     | Rename `governance/` → `repo-governance/` in `ose-primer`; update all path references      |
| **Out of scope** | Any content changes inside governance files                                                |
| **Out of scope** | Parent repo `CLAUDE.md` (no `ose-primer/governance/` references exist there)               |
...
2. Pass A — mass `sed` replace `governance/` → `repo-governance/` across all text files (excluding
...
5. Pass C — CLI verb `governance vendor-audit` (space-separated)
6. Pass D — hyphenated form `governance-vendor-audit`
