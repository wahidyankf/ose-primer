...
| Drift                                          | Cost                                                                                                                                                                                                                                                                                               |
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.opencode/agent/` singular (W1)               | Synced agents likely invisible to OpenCode in every clone of this template; bug propagates silently; opencode-go migration would hard-code wrong path deeper.                                                                                                                                      |
