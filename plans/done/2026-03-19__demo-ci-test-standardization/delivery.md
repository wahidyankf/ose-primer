...
- [x] **Update Go version in ALL scheduled workflows using Go 1.24**
  - [x] `test-a-demo-be-golang-gin.yml`: Change `go-version: "1.24"` to `"1.26.0"` in both jobs
  - [x] `test-a-demo-fe-ts-nextjs.yml`: Change `go-version: "1.24"` to `"1.26.0"`
  - [x] `test-a-demo-fe-ts-tanstack-start.yml`: Change `go-version: "1.24"` to `"1.26.0"`
  - [x] `test-a-demo-fe-dart-flutterweb.yml`: Change `go-version: "1.24"` to `"1.26.0"`
  ...
  - **Files Changed**: `.github/workflows/test-a-demo-be-golang-gin.yml`, `.github/workflows/test-a-demo-fe-ts-nextjs.yml`, `.github/workflows/test-a-demo-fe-ts-tanstack-start.yml`, `.github/workflows/test-a-demo-fe-dart-flutterweb.yml`

- [x] **Update Elixir version in test-a-demo-be-elixir-phoenix.yml**
  ...
  - **Implementation Notes**: Both integration-tests and e2e jobs updated to `elixir-version: "1.19"`. Verified `test_load_filters: [~r/_test\.exs$/, ~r/_steps\.exs$/]` already present in `apps/a-demo-be-elixir-phoenix/mix.exs` line 17.
  - **Date**: 2026-03-19
  - **Status**: Files updated; manual trigger verification pending
  - **Files Changed**: `.github/workflows/test-a-demo-be-elixir-phoenix.yml`

- [x] **Update Python version in test-a-demo-be-python-fastapi.yml**
  ...
  - **Date**: 2026-03-19
  - **Status**: Files updated; manual trigger verification pending
  - **Files Changed**: `.github/workflows/test-a-demo-be-python-fastapi.yml`
...
- [x] **Audit remaining workflows for version consistency**
  ...
  - **Implementation Notes**: All remaining workflows (clojure, csharp, fsharp, java-springboot, java-vertx, kotlin-ktor, ts-effect) use `node-version: "24"` — consistent. `test-a-demo-be-rust-axum.yml` does not use a host Rust toolchain step; Rust compilation occurs inside Docker containers — no `dtolnay/rust-toolchain` to check. `test-a-demo-fe-dart-flutterweb.yml` uses `subosito/flutter-action@v2` with `channel: stable` — consistent. No additional version mismatches found.
  - **Date**: 2026-03-19
  - **Status**: Completed
...
- [x] **a-demo-be-golang-gin: Add typecheck target**
  ...
  - [x] Run `nx run a-demo-be-golang-gin:codegen` first, then verify `go vet ./...` passes
  - [x] Verify `nx run a-demo-be-golang-gin:typecheck` passes
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-golang-gin/project.json`

- [x] **a-demo-be-rust-axum: Add typecheck target**
  - [x] Add to `project.json`:
  ...
  - [x] Verify `nx run a-demo-be-rust-axum:typecheck` passes
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-rust-axum/project.json`

- [x] **a-demo-be-kotlin-ktor: Add typecheck target**
  - [x] Add to `project.json`:
  ...
  - [x] Verify `nx run a-demo-be-kotlin-ktor:typecheck` passes
  - **Implementation Notes**: Uses same JAVA_HOME resolution pattern as other Kotlin targets. Added after `lint` target.
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-kotlin-ktor/project.json`

- [x] **a-demo-be-clojure-pedestal: Add typecheck target**
  - [x] Add to `project.json`:
  ...
  - [x] Verify `nx run a-demo-be-clojure-pedestal:typecheck` passes
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-clojure-pedestal/project.json`

- [x] **Fix existing typecheck targets missing codegen dependency**
  - [x] `a-demo-be-elixir-phoenix`: Add `dependsOn: ["codegen"]` (currently missing)
  - [x] `a-demo-be-python-fastapi`: Add `dependsOn: ["codegen"]` (currently missing)
  - [x] `a-demo-be-java-springboot`: Verify `dependsOn` includes `codegen` (has it)
  - [x] `a-demo-be-java-vertx`: Verify `dependsOn` includes `codegen` (has it)
  - [x] `a-demo-be-fsharp-giraffe`: Verify `dependsOn` includes `codegen` (has it)
  - [x] `a-demo-be-csharp-aspnetcore`: Verify `dependsOn` includes `codegen` (has it)
  - [x] `a-demo-be-ts-effect`: Verify `dependsOn` includes `codegen` (has it)
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-elixir-phoenix/project.json`, `apps/a-demo-be-python-fastapi/project.json`

- [x] **Run full typecheck sweep**
  - [x] `nx run-many -t typecheck --projects=a-demo-be-*` — all 11 backends pass
...
**Validation**: `nx run-many -t typecheck --projects=a-demo-be-*` exits 0. All 11 backends have
typecheck targets.
...
- [x] **Update a-demo-be-elixir-phoenix/project.json**
  ...
  - [x] Verify `nx run a-demo-be-elixir-phoenix:test:unit` passes
  - [x] Verify `nx run a-demo-be-elixir-phoenix:test:quick` passes with coverage
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-elixir-phoenix/project.json`
...
- [x] **Update a-demo-be-fsharp-giraffe/project.json**
  ...
  - [x] Verify `nx run a-demo-be-fsharp-giraffe:test:quick` passes
  - [x] Verify `nx run a-demo-be-fsharp-giraffe:lint` passes
  ...
  - **Date**: 2026-03-19
  - **Status**: Completed
  - **Files Changed**: `apps/a-demo-be-fsharp-giraffe/project.json`
...
- [x] **Update a-demo-fe-dart-flutterweb/project.json**
  - [x] Change `test:quick` command to:
        `flutter test test/unit --coverage && (cd ../../apps/rhino-cli && CGO_ENABLED=0 go run main.go test-coverage validate apps/a-demo-fe-dart-flutterweb/coverage/lcov.info 70)`
...
- [x] **Define canonical inputs per language** (reference for all updates below):
  - Go: `["{projectRoot}/internal/**/*.go", "{projectRoot}/cmd/**/*.go", "{projectRoot}/go.mod", "{projectRoot}/go.sum", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Java (Maven): `["{projectRoot}/src/**", "{projectRoot}/pom.xml", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Kotlin (Gradle): `["{projectRoot}/src/**", "{projectRoot}/build.gradle.kts", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Rust: `["{projectRoot}/src/**/*.rs", "{projectRoot}/tests/**/*.rs", "{projectRoot}/Cargo.toml", "{projectRoot}/Cargo.lock", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - TypeScript: `["{projectRoot}/src/**/*.ts", "{projectRoot}/tests/**/*.ts", "{projectRoot}/vitest.config.ts", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Python: `["{projectRoot}/src/**/*.py", "{projectRoot}/tests/**/*.py", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Elixir: `["{projectRoot}/lib/**/*.ex", "{projectRoot}/test/**/*.exs", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - F#: `["{projectRoot}/src/**/*.fs", "{projectRoot}/tests/**/*.fs", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - C#: `["{projectRoot}/src/**/*.cs", "{projectRoot}/tests/**/*.cs", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
  - Clojure: `["{projectRoot}/src/**/*", "{projectRoot}/test/**/*", "{projectRoot}/tests.edn", "{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature"]`
...
- [x] **a-demo-be-golang-gin** (Go)
  ...
  - [x] test:unit: Add `{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature` to inputs (currently missing)
  ...
  - [x] Verify `nx run a-demo-be-golang-gin:test:quick` passes (90.34% coverage)

- [x] **a-demo-be-java-springboot** (Java/Maven)
  ...
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-java-springboot:test:quick` passes (91.54% coverage)

- [x] **a-demo-be-java-vertx** (Java/Maven)
  - [x] test:unit: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `outputs` for coverage files
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-java-vertx:test:quick` passes (92.51% coverage)

- [x] **a-demo-be-elixir-phoenix** (Elixir)
  - [x] test:unit: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `outputs` for coverage files (`cover/lcov.info`)
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-elixir-phoenix:test:quick` passes (92.59% coverage)

- [x] **a-demo-be-python-fastapi** (Python)
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-python-fastapi:test:quick` passes (92.05% coverage)

- [x] **a-demo-be-rust-axum** (Rust)
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-rust-axum:test:quick` passes (90.44% coverage)

- [x] **a-demo-be-fsharp-giraffe** (F#)
  - [x] test:unit: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs;
        add `{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature` to inputs (currently missing
        from test:unit)
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-fsharp-giraffe:test:quick` passes (90.54% coverage)

- [x] **a-demo-be-ts-effect** (TypeScript)
  - [x] test:unit: Add `{projectRoot}/generated-contracts/**/*` to inputs (has cache+inputs but
        missing contracts)
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-ts-effect:test:quick` passes (91.67% coverage)

- [x] **a-demo-be-kotlin-ktor** (Kotlin/Gradle)
  - [x] test:unit: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs;
        add `{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature` to inputs (currently missing
        from test:unit)
  - [x] test:quick: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs;
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-kotlin-ktor:test:quick` passes (96.71% coverage)

- [x] **a-demo-be-csharp-aspnetcore** (C#)
  - [x] test:unit: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs;
        add `{workspaceRoot}/specs/apps/a-demo/be/gherkin/**/*.feature` to inputs (currently missing
        from test:unit)
  - [x] test:quick: Add `cache: true`; add `{projectRoot}/generated-contracts/**/*` to inputs;
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-csharp-aspnetcore:test:quick` passes (99.23% coverage)

- [x] **a-demo-be-clojure-pedestal** (Clojure)
  ...
  - [ ] ~~test:quick: Add `rhino-cli spec-coverage validate`~~ **DEFERRED** (see Go notes above)
  - [x] test:integration: Verify `cache: false` is explicit
  - [x] Verify `nx run a-demo-be-clojure-pedestal:test:quick` passes (93.08% coverage)

- [x] **a-demo-fe-ts-nextjs** (TypeScript/Next.js)
  ...
  - [x] Verify `nx run a-demo-fe-ts-nextjs:test:quick` passes (74.60% coverage)

- [x] **a-demo-fe-ts-tanstack-start** (TypeScript/TanStack)
  - [x] test:unit: Add `cache: true`, `inputs` with source + contracts
  - [x] test:unit: Add `{projectRoot}/src/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `cache: true`, `inputs` with source + contracts, `outputs` with coverage
  - [x] Verify `nx run a-demo-fe-ts-tanstack-start:test:quick` passes (74.15% coverage)

- [x] **a-demo-fe-dart-flutterweb** (Dart/Flutter)
  - [x] test:unit: Add `cache: true`, `inputs` with source + contracts
  - [x] test:unit: Add `{projectRoot}/generated-contracts/**/*` to inputs
  - [x] test:quick: Add `cache: true`, `inputs` with source + contracts, `outputs` with coverage
  - [x] Verify `nx run a-demo-fe-dart-flutterweb:test:quick` passes (88.33% coverage)

- [x] **Add codegen dependency to build targets** (currently missing in 10 backends)
  - [x] a-demo-be-golang-gin: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-java-springboot: Change `dependsOn: []` to `dependsOn: ["codegen"]` on `build`
  - [x] a-demo-be-java-vertx: Change `dependsOn: []` to `dependsOn: ["codegen"]` on `build`
  - [x] a-demo-be-elixir-phoenix: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-python-fastapi: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-fsharp-giraffe: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-ts-effect: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-kotlin-ktor: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-csharp-aspnetcore: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-clojure-pedestal: Add `dependsOn: ["codegen"]` to `build`
  - [x] a-demo-be-rust-axum: Already has it — verified
  - [x] a-demo-fe-dart-flutterweb: Already has it — verified
...
- [x] **Update docker-compose.yml health checks** (infra/dev/a-demo-be-\*)
  - [x] a-demo-be-golang-gin: Changed wget to `curl -f http://localhost:8201/health`
  - [x] a-demo-be-java-springboot: Changed wget to `curl -f http://localhost:8201/health`
  - [x] a-demo-be-java-vertx: Changed `wget -q -O /dev/null` to `curl -f http://localhost:8201/health`;
        normalized interval from 15s to 30s, retries from 5 to 3; also updated docker-compose.ci.yml
  - [x] a-demo-be-kotlin-ktor: Changed wget to `curl -f http://localhost:8201/health`
  - [x] a-demo-be-clojure-pedestal: Changed `wget -q -O /dev/null` to
...
- [x] **Update docker-compose.integration.yml health checks** (apps/a-demo-be-\*)
...
- [x] **apps/a-demo-be-golang-gin/README.md** — Added typecheck target, codegen dependency notes
- [x] **apps/a-demo-be-java-springboot/README.md** — Updated codegen dependency notes
- [x] **apps/a-demo-be-java-vertx/README.md** — Added typecheck target, codegen dependency notes
- [x] **apps/a-demo-be-elixir-phoenix/README.md** — Documented test:unit vs test:quick separation, codegen deps
- [x] **apps/a-demo-be-python-fastapi/README.md** — Updated codegen dependency notes
- [x] **apps/a-demo-be-rust-axum/README.md** — Added typecheck target, codegen dependency notes
- [x] **apps/a-demo-be-fsharp-giraffe/README.md** — Documented lint separation, codegen deps
- [x] **apps/a-demo-be-ts-effect/README.md** — Added codegen target, updated dependency notes
- [x] **apps/a-demo-be-kotlin-ktor/README.md** — Added typecheck + codegen targets
- [x] **apps/a-demo-be-csharp-aspnetcore/README.md** — Added codegen row, updated dependency notes
- [x] **apps/a-demo-be-clojure-pedestal/README.md** — Added typecheck + codegen targets
- [x] **apps/a-demo-fe-ts-nextjs/README.md** — Documented contract cache inputs
- [x] **apps/a-demo-fe-ts-tanstack-start/README.md** — Created README with contract cache inputs
- [x] **apps/a-demo-fe-dart-flutterweb/README.md** — Documented 70% coverage, lint separation, contracts
- [x] **apps/a-demo-be-e2e/README.md** — Fixed test:quick comment (lint + typecheck in parallel)
- [x] **apps/a-demo-fe-e2e/README.md** — Already correct, no changes needed

#### 6E: Specs and contracts docs

- [x] **specs/apps/a-demo/README.md** — Added spec consumption section (all 3 levels, deferred note)
- [x] **specs/apps/a-demo/be/README.md** — Added Nx cache inputs section, spec-coverage deferred note
- [x] **specs/apps/a-demo/contracts/README.md** — Added Nx cache integration section, adoption status table
...
- [x] **Run full local target sweep**
  ...
  - [x] Verify cache invalidation: modified health-check.feature → a-demo-be-golang-gin cache miss
        (re-ran). Reverted.
