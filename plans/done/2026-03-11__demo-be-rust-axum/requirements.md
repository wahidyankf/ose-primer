# Requirements: demo-be-rust-axum
...
- **Integration tests** (`test:integration`): Axum `tower::ServiceExt` in-process HTTP testing
  ...
  (InMemoryStore contexts), and `demo-be-fsharp-giraffe` (ASP.NET Core TestServer + SQLite in-memory).
...
- Port 8201 (mutually exclusive with demo-be-java-springboot, demo-be-elixir-phoenix, demo-be-fsharp-giraffe)
