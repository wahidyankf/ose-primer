# Plan: a-demo-be-rust-axum (In Progress)
...
`apps/a-demo-be-fsharp-giraffe` (F#/Giraffe) using Rust and the Axum web framework.
...
- Provide a functionally equivalent backend to `a-demo-be-java-springboot`, `a-demo-be-elixir-phoenix`, and
  `a-demo-be-fsharp-giraffe` using the Rust ecosystem
...
- `apps/a-demo-be-rust-axum/` — application source
- `infra/dev/a-demo-be-rust-axum/` — Docker Compose dev infra
- `.github/workflows/e2e-a-demo-be-rust-axum.yml` — E2E workflow
...
| File                              | Change                                                               |
| --------------------------------- | -------------------------------------------------------------------- |
| `CLAUDE.md`                       | Add a-demo-be-rust-axum to Current Apps list, add Rust coverage info |
| `README.md`                       | Add a-demo-be-rust-axum badge and description in demo apps section   |
| `specs/apps/a-demo/be/README.md`  | Add Rust/Axum row to Implementations table                           |
| `apps/a-demo-be-e2e/project.json` | Add `a-demo-be-rust-axum` to `implicitDependencies`                  |
