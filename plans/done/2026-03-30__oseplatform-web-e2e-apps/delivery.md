...
- [x] Create `apps/oseplatform-web-be-e2e/project.json` with all 7 Nx targets
...
- [x] Create `apps/oseplatform-web-be-e2e/package.json` with `@playwright/test@^1.58.2` and
      `playwright-bdd@^8.5.0` devDeps and `volta.extends` pointing to root
- [x] Create `apps/oseplatform-web-be-e2e/tsconfig.json` extending `../../tsconfig.base.json`
      with `CommonJS` module, includes `src/**/*.ts` and `playwright.config.ts`
- [x] Create `apps/oseplatform-web-be-e2e/oxlint.json` matching
      `apps/ayokoding-web-be-e2e/oxlint.json`
- [x] Create `apps/oseplatform-web-be-e2e/playwright.config.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/helpers.ts` (identical to ayokoding pattern):
      `buildTrpcUrl`, `extractTrpcData`, shared `state` object
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/common.steps.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/health-check.steps.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/content-api.steps.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/search-api.steps.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/rss-feed.steps.ts`:
...
- [x] Create `apps/oseplatform-web-be-e2e/src/steps/seo.steps.ts`:
...
- [x] Create `apps/oseplatform-web-fe-e2e/project.json` with same 7 Nx targets as BE E2E, tags
      `type:e2e`, `platform:playwright`, `lang:ts`, `domain:oseplatform`, and
      `"implicitDependencies": ["oseplatform-web"]`
- [x] Verify `test:e2e` inputs reference `specs/apps/oseplatform/fe/gherkin/**/*.feature`
- [x] Create `apps/oseplatform-web-fe-e2e/package.json` matching BE package.json (different name)
- [x] Create `apps/oseplatform-web-fe-e2e/tsconfig.json` (same as BE variant but adds
      `"lib": ["ES2022", "DOM"]` for Playwright browser-side DOM types)
- [x] Create `apps/oseplatform-web-fe-e2e/oxlint.json` (identical to BE variant)
- [x] Create `apps/oseplatform-web-fe-e2e/playwright.config.ts`:
...
- [x] Create `apps/oseplatform-web-fe-e2e/src/steps/common.steps.ts`:
      `Given("the app is running")` no-op
- [x] Create `apps/oseplatform-web-fe-e2e/src/steps/landing-page.steps.ts`:
...
- [x] Create `apps/oseplatform-web-fe-e2e/src/steps/navigation.steps.ts`:
...
- [x] Create `apps/oseplatform-web-fe-e2e/src/steps/theme.steps.ts`:
...
- [x] Create `apps/oseplatform-web-fe-e2e/src/steps/responsive.steps.ts`:
...
- [x] Create `infra/dev/oseplatform-web/` directory
- [x] Create `infra/dev/oseplatform-web/docker-compose.yml`:
...
- [x] Update `.github/workflows/test-and-deploy-oseplatform-web.yml` — replace `e2e` job:
...
- [x] Create `specs/apps/oseplatform/c4/README.md`:
...
- [x] Create `specs/apps/oseplatform/c4/context.md`:
...
- [x] Create `specs/apps/oseplatform/c4/container.md`:
  ...
  - Related links
- [x] Create `specs/apps/oseplatform/c4/component-be.md`:
  ...
  - Related links
- [x] Create `specs/apps/oseplatform/c4/component-fe.md`:
...
- [x] Add `oseplatform-web-be-e2e` to the **Current Apps** bullet list in CLAUDE.md:
  - Description: "Playwright BE E2E tests for oseplatform-web tRPC API"
- [x] Add `oseplatform-web-fe-e2e` to the **Current Apps** bullet list in CLAUDE.md:
...
- [x] Delete `apps/oseplatform-web/test/visual/pages.spec.ts`
- [x] Delete `apps/oseplatform-web/playwright.config.ts`
- [x] Inspect `apps/oseplatform-web/project.json` — confirm no target references
...
- [x] Remove the `apps/oseplatform-web/test/visual/` directory (now empty)
- [x] Note: `apps/oseplatform-web/test/` still contains `unit/` and `integration/` — do NOT
