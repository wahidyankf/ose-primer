# Plan: Create `a-demo-fs-ts-nextjs` — Fullstack Next.js App
...
Build a new fullstack TypeScript app (`apps/a-demo-fs-ts-nextjs`) using Next.js 16 that
...
This is the first **fullstack** (`fs`) demo app — all existing demos are either `a-demo-be-*`
(backend only) or `a-demo-fe-*` (frontend only). The fullstack app:
...
- Must pass **both** [BE Gherkin specs](../../../specs/apps/a-demo/be/gherkin/README.md) and [FE Gherkin specs](../../../specs/apps/a-demo/fe/gherkin/README.md)
