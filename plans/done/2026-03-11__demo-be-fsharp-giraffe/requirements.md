# Requirements: demo-be-fsharp-giraffe
...
- **Integration tests** (`test:integration`): ASP.NET Core TestServer + in-memory database
  ...
  Matches the monorepo convention established by `demo-be-java-springboot` (MockMvc + InMemoryDataStore)
  and `demo-be-elixir-phoenix` (InMemoryStore contexts).
...
- Port 8201 (mutually exclusive with demo-be-java-springboot and demo-be-elixir-phoenix)
