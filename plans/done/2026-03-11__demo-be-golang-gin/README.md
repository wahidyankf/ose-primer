# Plan: a-demo-be-golang-gin (In Progress)
...
`apps/a-demo-be-fsharp-giraffe` (F#/Giraffe) using Go 1.24+ and Gin.
...
- `apps/a-demo-be-golang-gin/` — application source
- `infra/dev/a-demo-be-golang-gin/` — Docker Compose dev infra
- `.github/workflows/e2e-a-demo-be-golang-gin.yml` — E2E workflow
