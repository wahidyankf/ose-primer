...
- **demo-be-java-springboot** - Spring Boot backend service (port 8201, depends on demo-be-db)
- **demo-be-e2e** - Playwright API E2E tests (requires demo-be-java-springboot + demo-be-db)
...
- Starts `demo-be-java-springboot` (port 8201) with PostgreSQL database
...
```bash
# From infra/dev/demo-be-java-springboot directory
...
**Purpose**: PostgreSQL database for demo-be-java-springboot
...
**Note**: `demo-be-java-springboot` depends on `demo-be-db` with `condition: service_healthy`,
...
# Last 100 lines
docker-compose logs --tail=100 demo-be-java-springboot
```
...
docker-compose stop demo-be-java-springboot
```
...
- Mounts source code from `apps/demo-be-java-springboot/` (read-write)
...
1. **Edit code**: Make changes to any file in `apps/demo-be-java-springboot/src/`
...
# Edit apps/demo-be-java-springboot/src/main/java/com/organiclever/be/controller/HelloController.java
...
```bash
# From infra/dev/demo-be-java-springboot
docker compose build
```
...
**Production Docker images**: Defined in the app directory (`apps/demo-be-java-springboot/Dockerfile`), independent of this dev setup.
...
nx dev demo-be-java-springboot
# or
cd apps/demo-be-java-springboot && mvn spring-boot:run -Dspring-boot.run.profiles=dev
```
...
```bash
# In infra/dev/demo-be-java-springboot/.env
...
**demo-be-java-springboot** — custom health endpoint:
...
```bash
# Check logs
docker-compose logs demo-be-java-springboot

# Check if JAR file exists
ls -lh ../../apps/demo-be-java-springboot/target/demo-be-java-springboot-1.0.0.jar

# Rebuild the application
cd ../../apps/demo-be-java-springboot && mvn clean package -DskipTests
```
...
docker exec demo-be-java-springboot wget -O- http://localhost:8201/health
```
...
# Verify port mapping
docker port demo-be-java-springboot
...
- **Production Dockerfiles**: Multi-stage build in `apps/demo-be-java-springboot/Dockerfile`
...
docker compose up -d demo-be-java-springboot
...
- [demo-be-java-springboot README](../../../apps/demo-be-java-springboot/README.md)
