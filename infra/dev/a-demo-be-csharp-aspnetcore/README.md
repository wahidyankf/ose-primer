# Demo Backend Dev Stack — CSAS (C#/ASP.NET Core)

Local development environment for `a-demo-be-csharp-aspnetcore`, the C#/ASP.NET Core
...
| Service                        | Port |
| ------------------------------ | ---- |
| a-demo-be-csharp-aspnetcore-db | 5432 |
| a-demo-be-csharp-aspnetcore    | 8201 |
...
| ------------------- | ------------------------------------------ | -------------------------------- |
| `POSTGRES_USER`     | `a_demo_be_csharp_aspnetcore`              | PostgreSQL username              |
| `POSTGRES_PASSWORD` | `a_demo_be_csharp_aspnetcore`              | PostgreSQL password              |
